...
cur.execute("""INSERT OR REPLACE INTO users(userid, fname, lname, gender) 
...
cur.executemany("INSERT OR REPLACE INTO users VALUES(?, ?, ?, ?);", more_users)
conn.commit()
...
cur.executemany("INSERT OR REPLACE INTO users VALUES(?, ?, ?, ?);", customers)
